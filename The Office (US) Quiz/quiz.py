...
def question30(question29_win):
    ...
    question30_win.title('The Office (US) Quiz - Q30')

    q30_label = tk.Label(
        question30_win,
        text='Andy Bernard is the top salesperson',
        font=('Arial',20)
    )
    q30_label.grid(
        row=1,
...
def question29(question28_win):
    ...
    question29_win.title('The Office (US) Quiz - Q29')

    q29_label = tk.Label(
        question29_win,
        text='Bob Vance owns Vance Refrigeration',
        font=('Arial',20)   
    )
    q29_label.grid(
        row=1,
...
def question25(question24_win):
    ...
    def q25_incorrect():
        messagebox.showinfo('Result','Incorrect, The answer is Dwight Schrute')
        question26(question25_win)

    question25_win = Toplevel()
    question25_win.geometry('+0+0')
    question25_win.resizable(False,False)
    question25_win.title('The Office (US) Quiz - Q25')

    q25_label = tk.Label(
        question25_win,
        text='Who started the fire drill in "Stress Relief"?',
        font=('Arial',20)
    )
    q25_label.grid(
        row=1,
...
def question24(question23_win):
    ...
    def q24_incorrect():
        messagebox.showinfo('Result','Incorrect, The answer is Alan Brand')
        question25(question24_win)
    
    question24_win = Toplevel()
    question24_win.geometry('+0+0')
    question24_win.resizable(False,False)
    question24_win.title('The Office (US) Quiz - Q24')

    q24_label = tk.Label(
        question24_win,
        text='Who served as CEO during most of the early seasons?',
        font=('Arial',20)
    )
    q24_label.grid(
        row=1,
...
def question21(question20_win):
    ...
    question21_win.title('The Office (US) Quiz - Q21')

    q21_label = tk.Label(
        question21_win,
        text='Meredith Palmer works in accounting',
        font=('Arial',20)
    )
    q21_label.grid(
        row=1,
...
def question20(question19_win):
    ...
    def q20_incorrect():
        messagebox.showinfo('Result','Incorrect, The answer is the Michael Scott Paper Company')
        question21(question20_win)

    question20_win = Toplevel()
    question20_win.geometry('+0+0')
    question20_win.resizable(False,False)
    question20_win.title('The Office (US) Quiz - Q20')

    q20_label = tk.Label(
        question20_win,
        text="What is the name of Michael's short-lived company in season 5?",
        font=('Arial',20)
    )
    q20_label.grid(
        row=1,
...
def question18(question17_win):
    ...
    question18_win.title('The Office (US) Quiz - Q18')

    q18_label = tk.Label(
        question18_win,
        text='Oscar Martinez works as an accountant?',
        font=('Arial',20)
    )
    q18_label.grid(
        row=1,
...
def question16(question15_win):
    ...
    def q16_incorrect():
        messagebox.showinfo('Result','Incorrect, The answer is Schrute Farm')
        question17(question16_win)

    question16_win = Toplevel()
    question16_win.geometry('+0+0')
    question16_win.resizable(False,False)
    question16_win.title('The Office (US) Quiz - Q16')

    q16_label = tk.Label(
        question16_win,
        text="What is the name of Dwight Schrute's farm?",
        font=('Arial',20)
    )
    q16_label.grid(
        row=1,
