...
def question20(question19_win):
    ...
    def q20_incorrect():
        messagebox.showinfo('Result','Incorrect, The answer is Carlos Tartiere Stadium')
        results(question20_win)

    question20_win = Toplevel()
    question20_win.geometry('+0+0')
    question20_win.resizable(False,False)
    question20_win.title('LaLiga 25-26 Stadiums Quiz - Q20')

    q20_label = tk.Label(
        question20_win,
        text='What is the Real Oviedo Stadium called?',
        font=('Arial',20)
    )
    q20_label.grid(
        row=1,
...
def question19(question18_win):
    ...
    def q19_incorrect():
        messagebox.showinfo('Result','Incorrect, The answer is the Montilivi Stadium')
        question20(question19_win)

    question19_win = Toplevel()
    question19_win.geometry('+0+0')
    question19_win.resizable(False,False)
    question19_win.title('LaLiga 25-26 Stadiums Quiz - Q19')

    q19_label = tk.Label(
        question19_win,
        text='What is the Girona Stadium called?',
        font=('Arial',20)
    )
    q19_label.grid(
        row=1,
...
def question18(question17_win):
    ...
    def q18_incorrect():
        messagebox.showinfo('Result','Incorrect, The answer is the Son Moix')
        question19(question18_win)

    question18_win = Toplevel()
    question18_win.geometry('+0+0')
    question18_win.resizable(False,False)
    question18_win.title('LaLiga 25-26 Stadiums Quiz - Q18')

    q18_label = tk.Label(
        question18_win,
        text='What is the Mallorca Stadium Called?',
        font=('Arial',20)
    )
    q18_label.grid(
        row=1,
...
def question17(question16_win):
    ...
    def q17_incorrect():
        messagebox.showinfo('Result','Incorrect, The answer is the El Sadar Stadium')
        question18(question17_win)

    question17_win = Toplevel()
    question17_win.geometry('+0+0')
    question17_win.resizable(False,False)
    question17_win.title('LaLiga 25-26 Stadiums Quiz - Q17')

    q17_label = tk.Label(
        question17_win,
        text='What is the Osasuna Stadium called?',
        font=('Arial',20)
    )
    q17_label.grid(
        row=1,
...
def question16(question15_win):
    ...
    def q16_incorrect():
        messagebox.showinfo('Result','Incorrect, The answer is the Estadio Ciudad de Valencia')
        question17(question16_win)

    question16_win = Toplevel()
    question16_win.geometry('+0+0')
    question16_win.resizable(False,False)
    question16_win.title('LaLiga 25-26 Stadiums Quiz - Q16')

    q16_label = tk.Label(
        question16_win,
        text='What is the Levante stadium called?',
        font=('Arial',20)
    )
    q16_label.grid(
        row=1,
...
def question14(question13_win):
    ...
    def q14_incorrect():
        messagebox.showinfo('Result','Incorrect, The answer is the Mendizorrotza Stadium')
        question15(question14_win)

    question14_win = Toplevel()
    question14_win.geometry('+0+0')
    question14_win.resizable(False,False)
    question14_win.title('LaLiga 25-26 Stadiums Quiz - Q14')

    q14_label = tk.Label(
        question14_win,
        text='What is the Alavés Stadium called?',
        font=('Arial',20)
    )
    q14_label.grid(
        row=1,
...
def question13(question12_win):
    ...
    def q13_incorrect():
        messagebox.showinfo('Result','Incorrect, The answer is the Ramón Sánchez-Pizjuán Stadium')
        question14(question13_win)

    question13_win = Toplevel()
    question13_win.geometry('+0+0')
    question13_win.resizable(False,False)
    question13_win.title('LaLiga 25-26 Stadiums Quiz - Q13')

    q13_label = tk.Label(
        question13_win,
        text='What is the Sevilla Stadium called?',
        font=('Arial',20)
    )
    q13_label.grid(
        row=1,
